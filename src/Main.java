...
/*****************************PARA SU CORRECTO FUNCIONAMIENTO SE DEBE EDITAR***************************************/
				peer = new Servent("/home");
				if (args.length == 4) {
					try {
						peer = new Servent(args[2]);
						peer.connect(args[0], new Short(args[1]));
						peer.makePing();
						peer.makeQuery(args[3]);
					} catch (IOException e) {
